var singleplayer = {
	...
	endLevel:function(success){
		...
		if (success){
			...
			if (moreLevels){
				game.showMessageBox("Mission Complete!",function(){
					$('.gamelayer').hide();
					singleplayer.currentLevel++;
					singleplayer.startCurrentLevel();
				});
			} else {
				game.showMessageBox("Mission Complete!<br><br>Made by @davidg0.",function(){
					$('.gamelayer').hide();
					$('#gamestartscreen').show();
				});
			}
		} else {
			game.showMessageBox("You are killed.<br><br>Play again?",function(){
				$('.gamelayer').hide();
				singleplayer.startCurrentLevel();
			}, function(){
				$('.gamelayer').hide();
